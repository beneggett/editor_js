  ...
  let(:valid_data1) do
    {
      ...
      data: {
        content: [
          ...
          ['&lt;hello&gt;', '<b>world</b>'],
          ['添加<b><i><mark class="cdx-marker"><code class="inline-code">第一个行内标签</code></mark></i></b>',
           '<code class="inline-code"><mark class="cdx-marker"><del class="cdx-strikeout"><b><i>行内标签</i></b></del></mark></code>']
        ]
      }
    }
  end
