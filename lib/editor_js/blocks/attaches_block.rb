    ...
    class AttachesBlock < Base
      ...
      def render(_options = {})
        ...
        content_tag :div, class: css_name do
          html_str = content_tag :div, class: "#{css_name}__file-icon", data: { extension: extension },
                                       style: "color: #{EXTENSIONS[extension]};" do
          ...
          html_str += content_tag :a, class: "#{css_name}__download-button", href: file_info['url'], target: '_blank',
                                      rel: 'nofollow noindex noreferrer' do
